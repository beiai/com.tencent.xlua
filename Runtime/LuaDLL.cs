...
namespace XLua.LuaDLL
{
    ...
    public partial class Lua
    {
        ...
        {
            return XLuaApi.Lua.xlua_getglobal(L, name);
        }

        public static int xlua_setglobal(IntPtr L, string name)
        {
            return XLuaApi.Lua.xlua_setglobal(L, name);
        }

        public static void xlua_getloaders(IntPtr L)
        {
            XLuaApi.Lua.xlua_getloaders(L);
        }
        ...
        {
            XLuaApi.Lua.xlua_rawgeti(L, tableIndex, index);
        }

        public static void xlua_rawseti(IntPtr L, int tableIndex, long index)
        {
            XLuaApi.Lua.xlua_rawseti(L, tableIndex, index);
        }
        ...
        {
            return XLuaApi.Lua.pcall_prepare(L, error_func_ref, func_ref);
        }
        ...
        public static void lua_pushstdcallcfunction(IntPtr L, XLuaApi.lua_CSFunction function, int n = 0)
        {
            XLuaApi.Lua.lua_pushstdcallcfunction(L, function, n);
        }

        public static int xlua_upvalueindex(int n)
        {
            return XLuaApi.Lua.xlua_upvalueindex(n);
        }

        public static int xlua_tointeger(IntPtr L, int index)
        {
            return XLuaApi.Lua.xlua_tointeger(L, index);
        }

        public static uint xlua_touint(IntPtr L, int index)
        {
            return XLuaApi.Lua.xlua_touint(L, index);
        }

        public static string lua_tostring(IntPtr L, int index)
        {
            return XLuaApi.Lua.lua_tostring(L, index);
        }

        public static void xlua_pushinteger(IntPtr L, int value)
        {
            XLuaApi.Lua.xlua_pushinteger(L, value);
        }

        public static void xlua_pushuint(IntPtr L, uint value)
        {
            XLuaApi.Lua.xlua_pushuint(L, value);
        }
        ...
        {
            XLuaApi.Lua.xlua_pushlstring(L, str, size);
        }
        ...
        {
            return XLuaApi.Lua.lua_tobytes(L, index);
        }

        public static int xlua_pgettable(IntPtr L, int idx)
        {
            return XLuaApi.Lua.xlua_pgettable(L, idx);
        }

        public static int xlua_psettable(IntPtr L, int idx)
        {
            return XLuaApi.Lua.xlua_psettable(L, idx);
        }
        ...
        {
            return XLuaApi.Lua.xluaL_loadbuffer(L, buff, size, name);
        }
        ...
        {
            return XLuaApi.Lua.xlua_tocsobj_safe(L, obj);
        }

        public static int xlua_tocsobj_fast(IntPtr L, int obj)
        {
            return XLuaApi.Lua.xlua_tocsobj_fast(L, obj);
        }
        ...
        {
            return XLuaApi.Lua.xlua_unpack_float5(buff, offset, out f1, out f2, out f3, out f4, out f5);
        }

        public static bool xlua_pack_float6(IntPtr buff, int offset, float f1, float f2, float f3, float f4,
            float f5, float f6)
        {
            return XLuaApi.Lua.xlua_pack_float6(buff, offset, f1, f2, f3, f4, f5, f6);
        }
        ...
        {
            return XLuaApi.Lua.xlua_unpack_float6(buff, offset, out f1, out f2, out f3, out f4, out f5, out f6);
        }

        public static bool xlua_pack_decimal(IntPtr buff, int offset, ref decimal dec)
        {
            return XLuaApi.Lua.xlua_pack_decimal(buff, offset, ref dec);
        }

        public static bool xlua_unpack_decimal(IntPtr buff, int offset, out byte scale, out byte sign,
            out int hi32, out ulong lo64)
        {
            return XLuaApi.Lua.xlua_unpack_decimal(buff, offset, out scale, out sign, out hi32, out lo64);
        }
        ...
        {
            return XLuaApi.Lua.xlua_is_eq_str(L, index, str, str_len);
        }

        public static IntPtr xlua_gl(IntPtr L)
        {
            return XLuaApi.Lua.xlua_gl(L);
        }
    }
}